...
pretrained_weights = {
    ...
    ("bert_multilingual", "base"): "bert-base-multilingual-cased"
}
...
def create_base_model(config):
    ...
    elif config["base_class"] == "bert_multilingual":
        return transformers.BertModel.from_pretrained(weights_name)
    else:
...
if __name__ == "__main__":
    ...
    tokenizer = create_tokenizer({"base_class": "bert_multilingual", "base_name": "base"})
