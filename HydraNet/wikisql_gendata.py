...
#     data_path = os.path.join("WikiSQL", "data")
    ...
    # ko_token_1
    data_path = os.path.join("data", "ko_token_1")   
    pre_type = "ko_token_1"
    
#     # ko_token_h_2
#     data_path = os.path.join("data", "ko_token_not_h_2")
#     pre_type = "ko_token_not_h_2"

#     # kotoken_from_table_3
#     data_path = os.path.join("data", "ko_from_table_3") 
#     pre_type = "ko_from_table_3"

#     # ko_from_table_not_h_4
#     data_path = os.path.join("data", "ko_from_table_not_h_4")
#     pre_type = "ko_from_table_not_h_4"
    
    for phase in ["train", "dev", "test"]:
        src_file = os.path.join(data_path, phase + ".jsonl")
        schema_file = os.path.join(data_path, phase + ".tables.jsonl")
        output_file = os.path.join("data", "wiki" + phase + pre_type + ".jsonl")
